  ...
  return (
    <div>
      <div className="flex flex-col sm:flex-row sm:justify-between sm:items-center gap-4 mb-6">
        <div>
          <h1 className="text-xl sm:text-2xl font-bold text-gray-900">Campeonatos</h1>
                  ...
                  <tr key={championship.id}>
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                      <div className="flex items-center">
                        <Trophy className="h-5 w-5 text-green-600 mr-2 sm:mr-3 flex-shrink-0" />
                        <span className="font-medium text-gray-900 text-sm sm:text-base truncate max-w-[120px] sm:max-w-none">{championship.name}</span>
                      </div>
                    </td>
                    ...
                    <td className="px-4 sm:px-6 py-4 whitespace-nowrap">
                      <span className={`inline-flex items-center px-2 py-0.5 rounded-full text-xs font-medium ${getStatusColor(championship.status)}`}>
          ...
          <div className="px-4 sm:px-6 py-4 space-y-4">
            ...
            <div>
              ...
              <input
                ...
                required
                className="mt-1 block w-full rounded-md border-gray-300 shadow-sm focus:border-green-500 focus:ring-green-500 text-sm border px-3 py-2"
              />
            </div>
            <div>
          ...
          {championshipDetail?.teams?.length === 0 ? (
            ...
            <ul className="space-y-2">
              {championshipDetail?.teams?.map((team) => (
                <li key={team.teamId} className="flex items-center justify-between bg-gray-50 px-3 sm:px-4 py-3 rounded-md">
                  <span className="font-medium text-gray-900 text-sm sm:text-base truncate mr-2">{team.teamName}</span>
                  <button
